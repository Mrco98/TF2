...
sr = 16000
dt = 1
model_fn = '/home/mark/TF2/enhanced-sirenmodel/models/conv.h5'
threshold = 20
...
def scan_siren(index):
    ...
    if classes[y_pred] == 'traffic' and y_mean[y_pred] >= 0.8:
        detected = True
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_fn', type=str, default='/home/mark/TF2/enhanced-sirenmodel/models/conv.h5',
                        help='model file to make predictions')
    parser.add_argument('--pred_fn', type=str, default='/home/mark/TF2/enhanced-sirenmodel/logs/T1',
                        help='fn to write predictions in logs dir')
    parser.add_argument('--src_dir', type=str, default='/home/mark/TF2/enhanced-sirenmodel/validation/T2',
